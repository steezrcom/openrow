...
func entitySchemaProperties() map[string]any {
	return map[string]any{
		"name": map[string]any{
			"type":        "string",
			"description": "Machine identifier, lowercase snake_case, matches ^[a-z][a-z0-9_]{0,62}$.",
		},
		...
		"description": map[string]any{
			"type":        "string",
			"description": "Optional one-sentence description of what this entity represents.",
		},
		"fields": map[string]any{
			...
			"items": map[string]any{
				...
				"properties": map[string]any{
					"name": map[string]any{
						"type":        "string",
						"description": "Machine identifier, lowercase snake_case.",
					},
					"display_name": map[string]any{
						"type":        "string",
						"description": "Human-facing label.",
					...
					"reference_entity": map[string]any{
						"type":        "string",
						"description": "If data_type is reference, the name of the referenced entity.",
					},
				},
